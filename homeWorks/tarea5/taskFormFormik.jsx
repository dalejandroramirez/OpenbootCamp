...
{ ( {values,
    ...
    <Form onSubmit={addTask} className='d-flex justify-content-center align-items-center mb-4'>
      <div className='form-outline flex-fill'>
          ...
          <Field id='taskName' type='text' name='taskName' placeholder='task Name' className='form-control form-control-lg' required autoFocus ref={nameRef}></Field>
          ...
          <Field id='descriptionName' type='text' name='descriptionName' placeholder='task Description' className='form-control form-control-lg' required ref={descriptionRef} ></Field>
          ...
          <Field as="select" name="color" className='form-control form-control-lg'>
